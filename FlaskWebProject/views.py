...
def login():
    ...
    if form.validate_on_submit():
        ...
        app.logger.info('Login Sucessful via Username and Password')
...
def authorized():
    ...
    if request.args.get('code'):
        ...
        app.logger.info('Login Sucessful via Microsoft Account')
        if "error" in result:
...
def logout():
    ...
    if session.get("user"):  # Used MS Login
        ...
        app.logger.info('User logged out from Microsoft Account')
        return redirect(
